...
* To be easy for many people to access.
* To be relatively easy to develop.
* To keep working in future decades.
...
SVG in HTML is included in the DOM, and we can modify is using JavaScript.
...
* Today I'm used D3 mostly for its ability to synchronize ("join") datasets with DOM objects.
...
## <img style="display:block;float:right;padding: 20px;" src="figures/idempotent-meme.jpg" width="400">"Idempotent"
...
Jupyter notebooks can also output JavaScript.
